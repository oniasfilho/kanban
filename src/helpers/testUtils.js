// testUtils.js
import {
  setGenericModal, setModalType, setCurrentBoard, setCurrentTask,
} from '../features/content/contentSlice';

const setupTestEnvironmentForCreateTaskModal = (store) => {
...
export default setupTestEnvironmentForCreateTaskModal;
